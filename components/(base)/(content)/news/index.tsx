    ...
    <section aria-label="news" className="py-12">
        <div className="px-4 mx-auto max-w-screen-xl">
            ...
            <article className="relative">
                ...
                <h2 className="mb-2 text-lg font-bold text-gray-900 dark:text-white">
                <Link prefetch={true} href="news/yunanistan-da-yeni-erasmus-anlasmasi-715854" rel="noopener noreferrer" className="line-clamp-2 hover:underline">Yunanistan da Yeni Erasmus Anlaşması</Link>
                </h2>
