    ...
    <section id="carousel" className="relative mt-2" data-carousel="static">
        <div id="baseCarousel" className="relative h-96 overflow-hidden">
            <div className="duration-400 ease-linear bg-gray-200 dark:bg-neutral-800 absolute inset-0 transition-transform transform translate-x-0 z-30" data-carousel-item="">
                <Link href='' rel="noopener noreferrer" aria-hidden="true">
                    <Image className="object-cover h-full w-full" alt="" width={1475} height={384} src="/0ce3cfb8-dcca-47f1-afd7-db00dab10be0.webp" />
                </Link>
            </div>
            <div className="duration-400 ease-linear bg-gray-200 dark:bg-neutral-800 absolute inset-0 transition-transform transform translate-x-full z-20" data-carousel-item="">
                <Link rel="noopener noreferrer" aria-hidden="true" href="https://misy.online/announcements/2024-yili-mezuniyet-toreni-hakkinda-onemli-duyuru-466834">
                    <Image className="object-cover h-full w-full" alt="" width={1475} height={384} src="/0ce3cfb8-dcca-47f1-afd7-db00dab10be0.webp" />
                </Link>         
            </div>
            <div className="duration-400 ease-linear bg-gray-200 dark:bg-neutral-800 absolute inset-0 transition-transform transform -translate-x-full z-10" data-carousel-item="">
                <Link rel="noopener noreferrer" aria-hidden="true" href="https://misy.online/announcements/2024-yili-mezuniyet-toreni-hakkinda-onemli-duyuru-466834">
                    <Image className="object-cover h-full w-full" alt=""  width={1475} height={384} src="/0ce3cfb8-dcca-47f1-afd7-db00dab10be0.webp" />
                </Link> 
            </div>
        ...
        <button type="button" className="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" aria-hidden="true" data-carousel-prev="">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60">
                <svg className="w-4 h-4 text-white dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 1 1 5l4 4"></path></svg>
            </span>
        </button>
        <button type="button" className="absolute top-0 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" aria-hidden="true" data-carousel-next="">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60">
                <svg className="w-4 h-4 text-white dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 9 4-4-4-4"></path></svg>          
            </span>
        </button>
    </section>
